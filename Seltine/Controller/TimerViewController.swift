...
class TimerViewController: UIViewController, AVSpeechSynthesizerDelegate, UINavigationControllerDelegate {
    ...
    private func setupView() {
        ...
        //タイトルの色
        taskTitle.textColor = .darkGray
        comingTaskTitle.textColor = .systemGray3
    ...
    private func setupCircleLayers() {
        ...
        let trackLayerA = createCircleShapeLayerA(strokeColor: .systemGray5, fillColor: .white)
        view.layer.addSublayer(trackLayerA)
        let trackLayerB = createCircleShapeLayerB(strokeColor: .systemGray5, fillColor: .white)
        view.layer.addSublayer(trackLayerB)
        //外側の円の色
        shapeLayerA = createCircleShapeLayerA(strokeColor: .darkGray, fillColor: .clearColor)
        shapeLayerA.transform = CATransform3DMakeRotation(-CGFloat.pi / 2, 0, 0, 1)
        shapeLayerA.strokeEnd = 0
        //内側の円の色
        shapeLayerB = createCircleShapeLayerB(strokeColor: .black, fillColor: .clearColor)
